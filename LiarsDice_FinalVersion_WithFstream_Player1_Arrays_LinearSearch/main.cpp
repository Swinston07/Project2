 ...
 *
 * Purpose: Using linear search to confirm if player is liar
 */
                ...
                //Initialize Variables/Input Values
                    do {
                        for(int i = 0; i < SIZE; i++){
                            die[i] = rand() % 6 + 1; // [1,6] faces of dice
                        }
                        ...
                        do {
                            ...
                            cin >> liar;
                                ...
                                if (liar == 'l' || liar == 'L') {
                                    ...
                                    //(call2 == die[0]) ? sumCount += die[0] :
                                    //                  sumCount += 0;
                                    //(call2 == die[1]) ? sumCount += die[1] : 
                                    //                  sumCount += 0;
                                    //(call2 == die[2]) ? sumCount += die[2] : 
                                    //                  sumCount += 0;
                                    //(call2 == die[3]) ? sumCount += die[3] : 
                                    //                  sumCount += 0;
                                    //(call2 == die[4]) ? sumCount += die[4] :   
                                    //                  sumCount += 0;
                                    //(call2 == die[5]) ? sumCount += die[5] : 
                                    //                  sumCount += 0;
                            ...
                            // Code for if Player 2 doesn't call Player 1 a liar
                                    ...
                                    isLiar = (count2 >= call3)? false:true;
                                        ...
                                        //    (call4 == die[0]) ? sumCount += die[0] : 
                                        //                      sumCount += 0;
                                        //    (call4 == die[1]) ? sumCount += die[1] : 
                                        //                      sumCount += 0;
                                        //    (call4 == die[2]) ? sumCount += die[2] : 
                                        //                      sumCount += 0;
                                        //    (call4 == die[3]) ? sumCount += die[3] :   
                                        //                     sumCount += 0;
                                        //    (call2 == die[4]) ? sumCount += die[4] : 
                                        //                      sumCount += 0;
                                        //    (call2 == die[5]) ? sumCount += die[5] :    
